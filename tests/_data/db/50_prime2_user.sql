...
INSERT INTO `prime2_user` (`id`, `email`, `password_hash`, `last_login_at`, `name`, `language`, `newsletter_subscription`, `created_at`, `updated_at`) VALUES (4, 'admin@user.com', '$2y$10$0tft2mUhhJWk5k9fvq1zdOPfV7d4z4RjjwiOiycwRr8hfSdc9waQO', 1, 'Admin', NULL, 1, '1970-01-01 00:00:01', '1970-01-01 00:00:01');
