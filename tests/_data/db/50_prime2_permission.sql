...
INSERT INTO `prime2_permission` (`id`, `source`, `source_id`, `target`, `target_id`, `permission`, `created_at`, `created_by`) VALUES (331, 'prime\\models\\ar\\User', '4', '{builtin}', '__global__', 'admin', NULL, NULL);
