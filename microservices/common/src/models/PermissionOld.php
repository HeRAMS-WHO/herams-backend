 ...
 */
class PermissionOld extends ActiveRecord
{
    ...
    public static function labels(): array
    {
        return array_merge(parent::labels(), [
            ...
            'permission' => \Yii::t('app.permission', 'PermissionOld'),
            'permissionLabel' => \Yii::t('app', 'PermissionOld'),
        ]);
    }
