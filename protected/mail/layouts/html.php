...
<div style="text-align: center;"><img alt="HeRAMS logo" src="<?=app()->urlManager->createAbsoluteUrl(['img/HeRAMS_Horizontal_withoutbaseline.png'])?>" style="height: 80px; margin-top: 20px;"></div>
