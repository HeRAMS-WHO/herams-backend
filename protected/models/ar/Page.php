...
class Page extends ActiveRecord implements PageInterface, Exportable
{
    ...
    public function titleOptions(): array
    {
        ...
        return [
            ...
            \Yii::t('app.pagetitle', 'Cancer services', null, $sourceLanguage),
            \Yii::t('app.pagetitle', 'Environmental cleaning', null, $sourceLanguage),
            \Yii::t('app.pagetitle', 'Personal protective equipment', null, $sourceLanguage),
            ...
            \Yii::t('app.pagetitle', 'Non-communicable diseases & mental health', null, $sourceLanguage),
            \Yii::t('app.pagetitle', 'NCD & mental health', null, $sourceLanguage),
            \Yii::t('app.pagetitle', 'Mental health', null, $sourceLanguage),
            \Yii::t('app.pagetitle', 'Hand hygiene', null, $sourceLanguage),
            \Yii::t('app.pagetitle', 'Communications', null, $sourceLanguage),
            \Yii::t('app.pagetitle', 'Cleaning equipment', null, $sourceLanguage),
