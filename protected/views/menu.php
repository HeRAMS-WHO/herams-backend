...
echo Nav::widget([
    ...
    'items' => [
        ...
        [
            'label' => Html::icon(\prime\models\ar\Setting::get('icons.user', 'asterisk'), ['title' => 'User']),
        ...
        [
            'label' => Html::icon(\prime\models\ar\Setting::get('icons.logOut', 'asterisk'), ['title' => 'Log out']),
