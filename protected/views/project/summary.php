        ...
        <?=
            Html::tag(
                ...
                implode(" ", [
                    ...
                    Html::tag('class', $project->facilityCount, ['class' => 'number']),
                    Html::tag('span', \Yii::t('app', 'Health facilities'))
                ])
            )
        ?></div>
    <div class="stat"><?=
                            Html::tag(
                                ...
                                implode(" ", [
                                    ...
                                    Html::tag('span', $project->contributorCount, ['class' => 'number']),
                                    Html::tag('span',  \Yii::t('app', 'Contributors'))
                                ])
                            )
                        ?></div>
