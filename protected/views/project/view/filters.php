...
<div class="filter-items">
  <div class="count">
    <span class="icon-count"> <?= Icon::healthFacility() ?></span>
    <span class="text"><?= \Yii::t('app', 'Health Facilities'); ?> </span>
    <?php echo Html::tag('em', count($data)); ?>
  </div>
  <div class="count">
    <span class="icon-count"><?php echo Icon::contributors() ?></span>
    <span class="text"><?= \Yii::t('app', 'Contributors'); ?></span>
    <?php echo Html::tag('em', $project->contributorCount); ?>
  </div>
  <div class="count">
    <span class="icon-count"><?php echo Icon::sync() ?></span>
    <span class="text"><?= \Yii::t('app', 'Latest update'); ?></span>
    <?php
...
<?php
if (app()->user->can(Permission::PERMISSION_WRITE, $project))
  echo Html::a('<span class="icon-edit"></span>', ['/project/' . $project->id . '/workspaces'], ['class' => 'btn btn-primary btn-grey icon-edit']);
?>
<?php
echo Html::a('Filters', '#', ['id' => 'filter-expand', 'class' => 'btn btn-primary btn-grey']);
$this->registerJs(
  <<<JS
