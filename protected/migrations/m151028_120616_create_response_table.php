...
class m151028_120616_create_response_table extends Migration
{
    public function up()
    {
        $responseTable = \prime\models\Response::tableName();
        ...
        $surveyTable = \prime\models\Survey::tableName();
        ...
        $this->addForeignKey('response_user', $responseTable, 'user_id', \prime\models\User::tableName(), 'id', 'RESTRICT', 'RESTRICT');
        $this->addForeignKey('response_project', $responseTable, 'user_id', \prime\models\Project::tableName(), 'id', 'RESTRICT', 'RESTRICT');
