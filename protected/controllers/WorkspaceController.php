...
class WorkspaceController extends Controller
{
    ...
    {
        if (isset($params['id'])) {
            $this->workspaceId = new WorkspaceId((int) $params['id']);
        }
    ...
    {
        if (!isset($params['tabMenuModel']) && isset($this->workspaceId)) {
            $params['tabMenuModel'] = $this->workspaceRepository->retrieveForTabMenu($this->workspaceId);
        }
